...
/**
 * Class TopMonthlyLinksTableController.
 */
class TopMonthlyLinksTableController extends Controller
{
    /**
    ...
    {
        return Datatables::of($this->repository->getMonthlyForDataTable())
            ->escapeColumns(['title'])
