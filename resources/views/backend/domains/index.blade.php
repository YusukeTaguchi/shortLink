...
@section('title', app_name() . ' | ' . __('labels.backend.access.domains.management'))
            ...
            <div class="col">
                <div class="table-responsive">
                    <table id="domains-table" class="table" data-ajax_url="{{ route("admin.domains.get") }}">
                        <thead>
                            <tr>
                                <th>{{ trans('labels.backend.access.domains.table.domain') }}</th>
                                <th>{{ trans('labels.backend.access.domains.table.url') }}</th>
                                <th>{{ trans('labels.backend.access.domains.table.status') }}</th>
